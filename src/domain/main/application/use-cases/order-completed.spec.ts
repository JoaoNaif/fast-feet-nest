...
describe('Delete Order', () => {
  ...
  it('must be able to edit an order', async () => {
    ...
    expect(inMemoryOrderRepository.items[0].attachment?.attachmentId).toEqual(
